...
export class KorisniciComponent implements OnInit {
  ...
  displayedColumnsZaposleni: string[] = ['position', 'email', 'role',  'delete', 'detalji'];
  displayedColumnsKlijenti: string[] = ['position', 'email', 'korisnickoIme', 'block', 'isblock','detalji' ];
  ...
  block(element : Korisnik) {
    ...
    if (!element.blokiran) {
      ...
      this.httpService.deblokiraj(environment.applicationConfig.server_url + "korisnik/deblokiraj", element.id).subscribe(result => {
        console.log("user is blocked");
